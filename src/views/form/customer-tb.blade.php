      ...
      <table width="100%" cellpadding="6">
        @foreach ($customer as $customer_row)
          <tr>
            ...
            <td width="20%" align="right" valign="top">{!! $controller->fa_format('Rp', number_format($customer_row->begining_balance, 2, ',', '.'), true)  !!}</td>
            <td width="20%" align="right" valign="top">{!! $controller->fa_format('Rp', number_format($customer_row->debit, 2, ',', '.'), true)  !!}</td>
            <td width="20%" align="right" valign="top">{!! $controller->fa_format('Rp', number_format($customer_row->credit, 2, ',', '.'), true)  !!}</td>
            <td width="20%" align="right" valign="top">{!! $controller->fa_format('Rp', number_format($customer_row->ending_balance, 2, ',', '.'), true)  !!}</td>
          </tr>
        @endforeach
        <tr>
          <td width="20%" align="right" valign="top"><b>TOTAL</b></td>
          <td width="20%" align="right" valign="top" class="amount"><b>{!! $controller->fa_format('Rp', number_format($total->begining_balance, 2, ',', '.'), true)  !!}</b></td>
          <td width="20%" align="right" valign="top" class="amount"><b>{!! $controller->fa_format('Rp', number_format($total->debit, 2, ',', '.'), true)  !!}</b></td>
          <td width="20%" align="right" valign="top" class="amount"><b>{!! $controller->fa_format('Rp', number_format($total->credit, 2, ',', '.'), true)  !!}</b></td>
          <td width="20%" align="right" valign="top" class="amount"><b>{!! $controller->fa_format('Rp', number_format($total->ending_balance, 2, ',', '.'), true)  !!}</b></td>
        </tr>
      </table>
    </div>
  </div>
