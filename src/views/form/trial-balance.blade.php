        ...
        <div class="container">
            <table width="100%" cellpadding="6" page-break-inside: auto;>
                <thead style="background:#72829c;color:white;">
                    <tr>
                        <th valign="top" align="center" width="14%">Account Code</th>
                ...
                <tbody style="border-left:  1px solid  #d4d7db;border-right:  1px solid  #d4d7db;">
                  @foreach ($data as $data_row)
                    <tr>
                        <td valign="top" align="center" width="14%" style="border-left:  1px solid  #d4d7db;">{{ $data_row->code }}</td>
                        <td valign="top" width="16%">{{ $data_row->name }}</td>
                        <td valign="top" align="right" width="16%">{{ number_format($data_row->LastBalance, 0, ',', '.') }}</td>
                        <td valign="top" align="right" width="18%">{{ number_format($data_row->Debit, 0, ',', '.') }}</td>
                        <td valign="top" align="right" width="18%">{{ number_format($data_row->Credit, 0, ',', '.') }}</td>
                        <td valign="top" align="right" width="18%" style="border-right:  1px solid  #d4d7db;">{{ number_format($data_row->EndingBalance, 0, ',', '.') }}</td>
                    </tr>
                  @endforeach
                </tbody>
            </table>
