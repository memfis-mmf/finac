...
<head>
  ...
  <title>{{$cash_advance->transaction_number}}</title>
  <style>
    @page {
      margin: 0cm 0cm;
    }
        ...
        <tr>
          ...
          <td width="55%" valign="top" align="center" style="padding-top:-16px">
            <h1 style="font-size:24px;">Payment<br>
              <span style="font-size:18px;">(cash_advance)</span>
            </h1>
          </td>
        </tr>
      </table>
        ...
        <tr>
          <td>
            <span style="margin-left:6px;">
              Created By : {{$cash_advance->created_by}} &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
              Approved By : {{$cash_advance->approved_by}} &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
