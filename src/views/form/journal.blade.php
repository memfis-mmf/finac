            ...
            <table width="100%" cellpadding="6" id="journal_table">
                <tr style="background:#72829c;color:white;">
	                ...
	                <tr>
	                    ...
	                    <td valign="top" align="right" width="16%">{{ ($x->debit < 1)? '': "Rp. ".number_format($x->debit, 0, 0, '.').",-" }}</td>
	                    <td valign="top" align="right" width="16%">{{ ($x->credit < 1)? '': "Rp. ".number_format($x->credit, 0, 0, '.').",-" }}</td>
	                </tr>
								@endfor
            </table>
