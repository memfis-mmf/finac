                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="text-align: right">
                          {{ "{$controller->currency_format((($item->Debit != 0)? $item->Debit: $item->Credit), 2)}" }}
                        </td>
                        <td>{!! $controller->fa_format('Rp', $controller->currency_format($item->rate, 2)) !!}</td>
                        <td>{!! $controller->fa_format('Rp', $controller->currency_format($item->Debit * $item->rate, 2)) !!}</td>
                        <td>{!! $controller->fa_format('Rp', $controller->currency_format(($item->Credit * -1) * $item->rate, 2)) !!}</td>
