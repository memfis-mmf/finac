<div class="input-group">
    ...
    <div class="input-group-append">
        <button class="btn m-btn m-btn--custom m-btn--pill btn-primary flaticon-search-1 checkprofit" data-id="{{$dataid or ''}}" data-toggle="{{ $data_toggle or 'modal' }}" data-target="{{ $data_target or '#' }}" type="button"></button>
    </div>
</div>
