                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                        <a href="/" class="m-brand__logo-wrapper">
                            <img src="{{asset('vendor/courier/img/LogoMMF.png')}}" alt="logo" height="50px">
                        </a>
                    </div>
                                        ...
                                        <div class="m-dropdown__header m--align-center" style="background: url(assets/metronic/app/media/img/misc/user_profile_bg.jpg); background-size: cover;">
                                            <div class="m-card-user m-card-user--skin-dark">
                                                ...
                                                <div class="m-card-user__details">
                                                    <span class="m-card-user__name m--font-weight-500">A</span>
                                                    <a href="" class="m-card-user__email m--font-weight-300 m-link">A</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="m-dropdown__body">
