                            ...
                            <div class="m-portlet__body">
                                <div class="form-group m-form__group row ">
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        @slot('id_error', 'bpjno')
                                        @slot('help_text','Bank Receipt Journal No.')
                                        @endcomponent
                                    </div>
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        <label class="form-control-label">
                                ...
                                <div class="form-group m-form__group row ">
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                        {{csrf_field()}}
                                        <label class="form-control-label">
                                            Receive To @include('label::required')
                                        </label>
            ...
            success: function(data) {
                if (data.errors) {
                    ...
                    for (i = 1; i <= data.casha.length; i++) {
                        ...
                        document.getElementById("creditadj1-" + i).value = data.casha[i - 1].credit;
