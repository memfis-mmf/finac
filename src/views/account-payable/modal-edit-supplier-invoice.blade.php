<div class="modal fade" id="modal_edit_supplier_invoice" role="dialog" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
            ...
            <div class="form-group m-form__group row ">
              <div class="col-sm-6 col-md-6 col-lg-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" id="amount_to_pay" name="debit" class="form-control m-input" style="" value=""
                    placeholder="" min="" max="">
