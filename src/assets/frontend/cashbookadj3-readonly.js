    ...
    init: function() {
        ...
        e = JSON.parse('[{"code":1,"name":"54473-251","debit":"GT","description":"San Pedro Ayampuc"},{"code":2,"name":"54473-251","debit":"GT","description":"San Pedro Ayampuc"},{"code":3,"name":"54473-251","debit":"GT","description":"San Pedro Ayampuc"},{"code":4,"name":"54473-251","debit":"GT","description":"San Pedro Ayampuc"},{"code":5,"name":"54473-251","debit":"GT","description":"San Pedro Ayampuc"},{"code":6,"name":"54473-251","debit":"GT","description":"San Pedro Ayampuc"},{"code":7,"name":"54473-251","debit":"GT","description":"San Pedro Ayampuc"},{"code":8,"name":"54473-251","debit":"GT","description":"San Pedro Ayampuc"},{"code":9,"name":"54473-251","debit":"GT","description":"San Pedro Ayampuc"},{"code":10,"name":"54473-251","debit":"GT","description":"San Pedro Ayampuc"}]'), a = $(".cashbookadj3_datatable").mDatatable({
            ...
            columns: [{
                ...
                width: 100,
                template: function (t) {
                    return '<input readonly style="width:100%" type="text" id="nameadj3-'+t.code+'" name="nameadj3-'+t.code+'" class="form-control m-input">'
                }
            }, {
                field: "debit",
                title: "Debit",
                ...
                template: function (t) {
                    return '<input readonly style="width:100%" type="text" onchange="curformat(this.value,this.id)" id="debitadj3-'+t.code+'" name="debitadj3-'+t.code+'" class="form-control m-input">'
                }
            }, {
                field: "credit",
                title: "Credit",
                ...
                template: function (t) {
                    return '<input readonly style="width:100%" type="text" onchange="curformat(this.value,this.id)" id="creditadj3-'+t.code+'" name="creditadj3-'+t.code+'" class="form-control m-input">'
                }
            }, {
                field: "description",
                title: "Description",
                width: 150,
                template: function (t) {
                    return '<input readonly style="width:100%" type="text" id="desriptionadj3-'+t.code+'" name="descriptionadj3-'+t.code+'" class="form-control m-input">'
                }
            }, {
                field: "Actions",
                width: 110,
