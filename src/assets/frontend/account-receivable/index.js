let Journal = {
    init: function () {
        ...
        let account_receivable_datatable_url = _url+'/account-receivable/datatables';
        ...
        let account_receivable_datatable = $('.account_receivable_datatable').DataTable({
          ...
          columns: [
            ...
            {data: 'ara.credit', searchabale: false,  render: function(data, type, row) {
        ...
        $(document).on('submit', '.form-filter-datatable', function (e) {
          ...
          account_receivable_datatable.ajax.url(account_receivable_datatable_url+'?'+data).load();
        });
        ...
        let remove = $('.account_receivable_datatable').on('click', '.delete', function () {
            ...
            swal({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        type: 'DELETE',
                        url: '/account-receivable/' + triggerid + '',
                        success: function (data) {
				...
				let approve = $('body').on('click', 'a.approve', function() {
					...
					$.ajax({
							...
							type: 'post',
							url: '/account-receivable/approve',
							data: {
									_token: $('input[name=_token]').val(),
									uuid: _uuid
							},
