...
use Directoryxx\Finac\Request\TypeAssetUpdate;
use Directoryxx\Finac\Request\TypeAssetStore;
...
class TypeAssetController extends Controller
{
    ...
    {
        return redirect()->route('typeasset.create');
    }

    public function create()
    {
        return view('typeassetview::index');        
    }
