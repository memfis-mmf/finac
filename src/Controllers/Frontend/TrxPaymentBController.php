...
class TrxPaymentBController extends Controller
{
    ...
    {
        return redirect()->route('trxpaymentb.create');
    }

    public function create()
    {
        return view('trxpaymentbview::index');        
    }
    ...
    public function api()
    {
        $trxpaymentbdata = TrxPaymentB::all();

        return json_encode($trxpaymentbdata);
    }

    public function apidetail(TrxPaymentB $trxpaymentb)
    {
        return response()->json($trxpaymentb);
    }
