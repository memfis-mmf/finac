...
class APCController extends Controller
{
    ...
    {
        return redirect()->route('APaymentC.create');
    }

    public function create()
    {
        return view('APaymentCview::index');
    }

    public function store(APaymentCStore $request)
    {
		$request->request->add([
			'description' => ''
		]);
        $APaymentC = APaymentC::create($request->all());
        return response()->json($APaymentC);
    }

    public function edit(APaymentC $APaymentC)
    {
        return response()->json($APaymentC);
    }

    public function update(APaymentCUpdate $request, APaymentC $APaymentC)
    {

        $APaymentC->update($request->all());

        return response()->json($APaymentC);
    }

    public function destroy(APaymentC $APaymentC)
    {
        $APaymentC->delete();
    ...
    public function api()
    {
        $APaymentCdata = APaymentC::all();

        return json_encode($APaymentCdata);
    }

    public function apidetail(APaymentC $APaymentC)
    {
        return response()->json($APaymentC);
    }
    ...
    {
        $data = $alldata = json_decode(APaymentC::All());
